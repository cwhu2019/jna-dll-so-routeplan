...
public class JnaLibCall {
	private static final String LIBPACKAGE = "cwhu.dllSolibLoad.lib.load.routeplanEngine";// 接口目录，根据自己的动态库接口所在包名进行修改
